...
function showManagementTab(name) {
  ...
  const copy = { settings: ['Settings', 'Company, staff, Bukku and printer settings.'], company: ['Company details', 'Business details used on every receipt.'], printer: ['Printer settings', 'Receipt paper and footer message.'], bukku: ['Bukku daily invoice', 'One closed shift can post one Normal Bukku invoice after its mapping is enabled.'], staff: ['Staff accounts', 'Create real cashier and manager accounts, then retire demo accounts.'], products: ['Products', 'Search your product catalogue. Use + to add a new local product.'], contacts: ['Contacts', 'Search your customer and contact list. Use + to add a new local contact.'] };
